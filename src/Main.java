...
public class Main {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        for(int i = 0; i<nonlands ; i++) {  //////////////lisab landid
            Thread.sleep(50);
            request("https://api.scryfall.com/cards/random?q="+nonlandsearch,urlid, nimed,writer);
        }
